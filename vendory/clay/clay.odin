...
//Vector2 :: [2]c.float
// Modified From Original Bindings.
Vector2 :: [2]f32
...
SizingGrow :: proc "c" (sizeMinMax: SizingConstraintsMinMax = {}) -> SizingAxis {
	return SizingAxis{type = SizingType.Grow, constraints = {sizeMinMax = sizeMinMax}}
}

SizingFixed :: proc "c" (size: c.float) -> SizingAxis {
	return SizingAxis{type = SizingType.Fixed, constraints = {sizeMinMax = {size, size}}}
}

SizingPercent :: proc "c" (sizePercent: c.float) -> SizingAxis {
...
EndChild :: #force_inline proc "contextless" (){
	_CloseElement()
}


// @Note: After Calling BeginDynamicChild() one Must Call ConfigDynamicChild() to set the ElementDeclartion.
// But this allows to dynamically change layout using things like 'Hovered()'


BeginDynamicChild :: proc {
	BeginDynamicChild_ID,
	BeginDynamicChild_Label,
	BeginDynamicChild_Label_Index,
}
...
BeginScopedDynamicChild :: proc {
	BeginScopedDynamicChild_ID,
	BeginScopedDynamicChild_Label,
	BeginScopedDynamicChild_Label_Index,
}
...
BeginScopedChild :: proc {
	BeginScopedChild_ID,
	BeginScopedChild_Label,
	BeginScopedChild_Label_Index,
}
