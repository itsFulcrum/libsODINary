...
when ODIN_OS == .Windows {
	foreign import assimp "../lib/release/assimp-vc143-mt.lib"
...
foreign assimp {
    ...
    */
	...
	//get_material_float :: proc(pMat: ^aiMaterial, pKey: cstring, type: u32, index: u32, pOut: ^f64) -> aiReturn ---

	@(link_name = "aiGetMaterialFloatArray")
	get_material_floatArray :: proc(pMat: ^aiMaterial, pKey: cstring, type: u32, index: u32, pOut: ^f32, pMax: ^u32) -> aiReturn ---
