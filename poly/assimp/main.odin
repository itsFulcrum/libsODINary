...
// DATA_BANANA_FBX   :: #load("test_monkey.usdc")

// main :: proc() {

//     mushroom := import_file_from_file("test_monkey.usdc", auto_cast ai.aiPostProcessSteps.Triangulate)
...
//     if mushroom != nil {
//         check_scene(mushroom, "mushroom.fbx");


//     } 
//     else{
        
//         err_cstr := get_error_string();
//         fmt.printf("Error loading scene! : ", err_cstr);
